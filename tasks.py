...
class feedingSchedule:
    ...
    def feedingSchedule_realtimeUpdate(self, col_snapshot, changes, read_time):
        print("Callback received Feeding Schedule.")
        ...
        for doc_id_to_remove in firestore_schedule_ids:
            self.local_schedules = [schedule for schedule in self.local_schedules if schedule.get('id') != doc_id_to_remove]
        ...
        # Print the synchronized local schedules
